...
class RadarNearbyViewController: UIViewController, BMKMapViewDelegate, BMKRadarManagerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let info = nearbyInfos[(indexPath as NSIndexPath).row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let annotation = _mapView.annotations[(indexPath as NSIndexPath).row] as! BMKAnnotation
    ...
    */
    ...
    func updateMyLocation(_ notification: Notification) {
        if let location = (notification as NSNotification).userInfo!["loc"] as? BMKUserLocation {
