...
class RootViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("location component version: \(BMKGetMapApiLocationComponentVersion())")
        ...
        print("radar    component version: \(BMKGetMapApiRadarComponentVersion())")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.text = _demoNameArray[(indexPath as NSIndexPath).row]
        return cell!
    }
    
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: _viewControllerArray[(indexPath as NSIndexPath).row])
        vc.title = _viewControllerTitleArray[(indexPath as NSIndexPath).row]
